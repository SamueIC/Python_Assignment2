...
class Validator(IFileValidator, Rules):
    ...
    def check_id(self, emp_id):
        ...
        try:
            if not re.match(Rules.get_attr(id_rule), emp_id):
    ...
    def check_age(self, age):
        ...
        try:
            if not re.match(Rules.get_attr(age_rule), str(age)):
    ...
    def check_gender(self, gender):
        ...
        # Exception handling by Tim
        try:
            if not re.match(Rules.get_attr(gender_rule), gender):
    ...
    def check_sales(self, sales):
        ...
        """
        try:
            if not re.match(Rules.get_attr(sales_rule), sales):
    ...
    def check_bmi(self, bmi):
        # Exception handling by Tim
        try:
            if not re.match(Rules.get_attr(bmi_rule), bmi):
    ...
    def check_salary(self, salary):
        # Exception handling by Tim
        try:
            if not re.match(Rules.get_attr(salary_rule), salary):
